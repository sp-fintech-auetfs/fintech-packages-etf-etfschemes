...
class AppsFintechEtfSchemesCustom extends BaseModel
{
    ...
    public function initialize()
    {
        $this->modelRelations['navs']['relationObj'] = $this->hasOne(
            'id',
            AppsFintechEtfSchemesCustomNavs::class,
            'id',
            [
                'alias'         => 'navs'
            ]
        ...
        $this->modelRelations['navs_chunks']['relationObj'] = $this->hasOne(
            'id',
            AppsFintechEtfSchemesCustomNavsChunks::class,
            'id',
            [
                'alias'         => 'navs_chunks'
            ]
        ...
        $this->modelRelations['rolling_returns']['relationObj'] = $this->hasOne(
            'id',
            AppsFintechEtfSchemesCustomNavsRollingReturns::class,
            'id',
            [
